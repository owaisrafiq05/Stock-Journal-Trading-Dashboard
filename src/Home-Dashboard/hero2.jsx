const hero2 = () => {
  ...
  return (
    <div className="overflow-x-auto relative shadow-md sm:rounded-lg w-[95%] mx-auto">
      <table
        className="spacing-table w-full text-sm text-left text-gray-400 rounded-3xl border-separate"
      ...
      >
        ...
        <tbody className="rowsDesk border ">
          {tableData.map((item, index) => (
            <tr
              key={index}
              className={`border mt-3 bg-gray-800  ${
            ...
            >
              ...
              <td className={`py-4 px-6 font-semibold ${item.statusColor}`}>
                {item.return}
              </td>
              <td className={`py-4 px-6 font-semibold ${item.statusColor}`}>
                {item.returnPerc}
        ...
        <tbody className="rowsMobile ">
          {tableData.map((item, index) => (
            <tr
              key={index}
              className={` mt-3 bg-gray-800  ${
                index === 0 ? "rounded-t-lg" : ""
              } ${index === tableData.length - 1 ? "rounded-b-lg" : ""}`}
            >
              <td className=" py-4 px-6">{item.date}</td>
